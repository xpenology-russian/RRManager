...
-- insert new tasks
INSERT INTO task VALUES('RunRrUpdate', '', 'bootup', '', 0, 0, 0, 0, '', 0, '. /var/packages/rr-manager/target/ui/config.txt && . /tmp/rr_update_filename && /usr/bin/rr-update.sh updateRR "$UPDATE_FILE" /tmp/rr_update_progress', 'script', '{}', '', '', '{}', '{}');
